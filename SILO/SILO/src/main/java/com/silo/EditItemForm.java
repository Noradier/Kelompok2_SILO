...
import com.silo.controller.UpdateItemCtl;
...
public class EditItemForm extends javax.swing.JFrame {
    ...
    private void onUpdateButtonClick(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_onUpdateButtonClick
        // TODO add your handling code here:
        updateItem();
    }//GEN-LAST:event_onUpdateButtonClick

    private void updateItem(){
        updateItemCtl.updateItem(new Item(
                updateItemCtl.getDaftarItemCtl().getMainPage().getEditedId(),
                barcodeTF.getText(),
                titleTF.getText(),
    ...
    public void setTextField(String barcode, String title, String description, String manufacturer, String url, int numberOfStock){
        barcodeTF.setText(barcode);
        titleTF.setText(title);
        descriptionTF.setText(description);
        manufacturerTF.setText(manufacturer);
        urlTF.setText(url);
        stockTF.setText(Integer.toString(numberOfStock));
    }
    
    public void setUpdateItemCtl(UpdateItemCtl updateItemCtl) {
        this.updateItemCtl = updateItemCtl;
        this.updateItemCtl.setEditItemForm(this);
    }
}
